package crazypants.enderio.conduit.oc.init;
...
import crazypants.enderio.conduit.oc.conduit.ItemOCConduit;
import net.minecraft.block.Block;
import net.minecraft.item.Item;

public enum ConduitOpenComputersObject implements IModObjectBase {

  item_opencomputers_conduit(ItemOCConduit::create),
  ...
  private ConduitOpenComputersObject(@Nonnull BiFunction<IModObject, Block, Item> itemMaker) {
    this(null, itemMaker, null);
  }

  private ConduitOpenComputersObject(@Nonnull Function<IModObject, Block> blockMaker) {
    this(blockMaker, null, null);
  }

  private ConduitOpenComputersObject(@Nonnull Function<IModObject, Block> blockMaker, @Nonnull BiFunction<IModObject, Block, Item> itemMaker) {
    this(blockMaker, itemMaker, null);
  }

  private ConduitOpenComputersObject(@Nonnull Function<IModObject, Block> blockMaker, @Nonnull IModTileEntity modTileEntity) {
    this(blockMaker, null, modTileEntity);
  }

  private ConduitOpenComputersObject(@Nullable Function<IModObject, Block> blockMaker, @Nullable BiFunction<IModObject, Block, Item> itemMaker,
