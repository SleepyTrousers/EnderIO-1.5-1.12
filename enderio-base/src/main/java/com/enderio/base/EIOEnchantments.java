...
public class EIOEnchantments {
    ...
    public static final RegistryEntry<AutoSmeltEnchantment> AUTO_SMELT = enchantmentBuilder("auto_smelt",
            new AutoSmeltEnchantment()).lang("Auto Smelt").register();
    public static final RegistryEntry<RepellentEnchantment> REPELLENT = enchantmentBuilder("repellent",
            new RepellentEnchantment()).lang("Repellent").register();
    public static final RegistryEntry<ShimmerEnchantment> SHIMMER = enchantmentBuilder("shimmer",
            new ShimmerEnchantment()).lang("Shimmer").register();
    public static final RegistryEntry<SoulBoundEnchantment> SOULBOUND = enchantmentBuilder("soulbound",
            new SoulBoundEnchantment()).lang("Soulbound").register();
    //TODO should crossbow and bow be handled as different enchant classes for the sake of levels/costs?
    public static final RegistryEntry<WitherArrowEnchantment> WITHER_ARROW = enchantmentBuilder("wither_arrow",
            new WitherArrowEnchantment()).lang("Wither Arrows").register();
    public static final RegistryEntry<WitherWeaponEnchantment> WITHER_WEAPON = enchantmentBuilder("wither_weapon",
            new WitherWeaponEnchantment()).lang("Wither Weapon").register();
    public static final RegistryEntry<XPBoostEnchantment> XP_BOOST = enchantmentBuilder("xp_boost",
            new XPBoostEnchantment()).lang("XP Boost").register();

    // endregion

    // region description

    public static final TranslatableComponent AUTO_SMELT_DESC = descriptionBuilder("auto_smelt",
            "Automatically smeltes whatever is mined");
    ...
    public static final TranslatableComponent XP_BOOST_DESC = descriptionBuilder("xp_boost",
    ...
    private static <T extends EIOBaseEnchantment> EnchantmentBuilder<T, Registrate> enchantmentBuilder(String name,
            T enchantment) {
    ...
    private static TranslatableComponent descriptionBuilder(String enchantmentname, String description) {
        return REGISTRATE.addLang("description.enchantment", new ResourceLocation(EnderIO.DOMAIN, enchantmentname),
                description);
    }
