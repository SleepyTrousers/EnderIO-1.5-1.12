...
public final class SpawnerConfig {
  ...
  public static final IValue<RebuildableThings> brokenSpawnerToolBlacklist = F.make("brokenSpawnerToolBlacklist",
      new RebuildableThings("item:rotarycraft:rotarycraft_item_bedpick"), //
