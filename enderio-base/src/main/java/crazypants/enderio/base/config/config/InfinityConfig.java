...
public final class InfinityConfig {
  ...
  public static final IValue<Integer> infinityMinAge = F.make("infinityMinAge", 260, //
      "How old (in ticks) does a dying fire have to be to spawn Infinity Powder? (average fire age at death is 11.5s, defauilt is 13s").setRange(1, 1000)
      .sync();
