...
public class CapPowerBar implements IDrawingElement {
  ...
  private final @Nonnull EnergyTank tank;
  private final @Nonnull GuiContainerBaseEIO owner;
  private final @Nonnull PowerBarTooltip tooltip;
  private int x, y, width, height;

  public CapPowerBar(@Nonnull EnergyTank tank, @Nonnull GuiContainerBaseEIO owner, int height) {
    this(tank, owner, -1, -1, -1, height);
  }

  public CapPowerBar(@Nonnull EnergyTank tank, @Nonnull GuiContainerBaseEIO owner) {
    this(tank, owner, -1, -1, -1, -1);
  }

  public CapPowerBar(@Nonnull EnergyTank tank, @Nonnull GuiContainerBaseEIO owner, int x, int y) {
    this(tank, owner, x, y, -1, -1);
  }

  public CapPowerBar(@Nonnull EnergyTank tank, @Nonnull GuiContainerBaseEIO owner, int x, int y, int height) {
    this(tank, owner, x, y, -1, height);
  }

  public CapPowerBar(@Nonnull EnergyTank tank, @Nonnull GuiContainerBaseEIO owner, int x, int y, int width, int height) {
    this.tank = tank;
    this.owner = owner;
    this.x = x > 0 ? x : 16;
    this.y = y > 0 ? y : 14;
