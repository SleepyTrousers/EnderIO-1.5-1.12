...
public class ConduitDisplayMode {
  ...
  /**
   * Use this constructor if you have custom display logic, it will use {@code IConduit.class} as the conduitType, and the passed name as the override name.
   * 
  ...
  /**
   * Creates a new display mode for any {@link IConduitControl} wrench. Contains data about which conduit type this is for, and the icons to render while
   * holding the wrench. wrench.
   * 
   * @param conduitType
   *          The base class for your conduit type, typically an interface (e.g. {@code IPowerConduit}).
   * @param widgetSelected
   *          The widget to render when this type is selected.
   * @param widgetUnselected
   *          The widget to render when this type is unselected.
