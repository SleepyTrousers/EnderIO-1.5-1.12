...
public abstract class ThaumcraftArmorMixin extends Item implements IVisDiscountGear, IGoggles, IRevealer {
  ...
  public boolean showNodes(ItemStack stack, EntityLivingBase player) {
    return stack != null && Prep.isValid(stack) && (player instanceof EntityPlayer) && DarkSteelController.isActive((EntityPlayer) player, Type.GOGGLES)
        && GogglesOfRevealingUpgrade.INSTANCE.hasUpgrade(stack);
  }
