...
public enum KeyTracker {
  ...
  fovReset(Keyboard.KEY_NONE, CATEGORY.MISC, new FovZoomHandler.FovResetAction()),
  fovUnReset(Keyboard.KEY_NONE, CATEGORY.MISC, new FovZoomHandler.FovUnresetAction()),
  fovStore(Keyboard.KEY_NONE, CATEGORY.MISC, new FovZoomHandler.FovStoreAction()),
  fovRecall(Keyboard.KEY_NONE, CATEGORY.MISC,
      new FovZoomHandler.FovRecallAction()),
