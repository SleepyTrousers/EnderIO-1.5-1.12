...
public enum EquipmentData {
  DARK_STEEL(35, new int[] { 2, 5, 6, 2 }, new int[] { 3, 6, 8, 3 }, 15, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1f, 2f, "darkSteel", Config.darkSteelPickMinesTiCArdite ? 5 : 3, 2000, 8, 3.0001f, 25, Alloy.DARK_STEEL.getOreIngot(),
  ...
  END_STEEL(50, new int[] { 4, 7, 10, 4 }, new int[] { 5, 8, 12, 5 }, 25, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 3f, 4f, "endSteel",
          Config.endSteelPickMinesTiCArdite ? 5 : 3, 2000, 12, 5f, 30,  Alloy.END_STEEL.getOreIngot(),"end_steel_layer_1", "end_steel_layer_2", 2) {
  ...
  private EquipmentData(int maxDamageFactor, @Nonnull int[] damageReduction, @Nonnull int[] damageReductionEmpowered, int armorEnchantability, SoundEvent soundEvent,
                        float toughness, float toughnessEmpowered, String toolMaterialName, int harvestLevel, int maxUses, float efficiency, float damage, int toolEnchanability,
                        @Nonnull String repairIngotOredict, @Nonnull String texture1, @Nonnull String texture2, @Nonnull Integer tier) {

    this.armorMaterial = NullHelper.notnullF(EnumHelper.addArmorMaterial(name(), name(),  maxDamageFactor, damageReduction, armorEnchantability, soundEvent, toughness),
  ...
  public @Nonnull Integer getTier() { return tier; }
}
