...
public class ClientUtil
{
    public static void doFluidLevelUpdate(int x, int y, int z, PacketFluidLevel pkt)
    {
        ...
        if (pkt.tc == null || !(tile instanceof IConduitBundle)) { return; }
    ...
    public static void spawnFarmParcticles(Random rand, BlockCoord bc)
    {
        ...
        Minecraft.getMinecraft().theWorld.spawnParticle("portal", bc.x + xOff, bc.y + yOff, bc.z + zOff, (rand.nextDouble() - 0.5) * 1.5, -rand.nextDouble(), (rand.nextDouble() - 0.5) * 1.5);
    }
