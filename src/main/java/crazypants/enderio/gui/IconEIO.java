...
public final class IconEIO {
  ...
  public static final IconEIO PROBE_OVERLAY_PROBE = new IconEIO(112, 100);
  public static final IconEIO PROBE_OVERLAY_COPY = new IconEIO(160, 100);
  public static final IconEIO PROBE_OVERLAY_PROBE_OFF = new IconEIO(144, 100);
  public static final IconEIO PROBE_OVERLAY_COPY_OFF = new IconEIO(128, 100);
