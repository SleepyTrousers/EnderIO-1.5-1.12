...
public enum Capacitors {
    ...
    ENDER_CAPACITOR(new BasicCapacitor(3, 400, 500000, 100), "enderCapacitor", "Ender"),
    ...
    ENDERGETIC_CAPACITOR(new BasicCapacitor(2, 240, 200000, 60), "endergeticCapacitor", "Advanced"),
