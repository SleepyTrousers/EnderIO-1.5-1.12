...
public class ItemLocationPrintout extends Item implements IGuiHandler {
  ...
  @Override
  public EnumActionResult onItemUse(ItemStack stack, EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX,
    ...
    if (tp.canBlockBeAccessed(player)) {
      ...
      BlockPos bc = TelepadTarget.getTargetPos(stack.getTagCompound());
      if(bc == null) {
      ...
      if (!bc.equals(cur)) {
        ...
        player.addChatMessage(new TextComponentString(EnderIO.lang.localize("itemCoordSelector.chat.setCoords", portMe.chatString())));
      }
      ...
      if (dim != curDim) {
        ...
        player.addChatMessage(
            new TextComponentString(EnderIO.lang.localize("itemCoordSelector.chat.setDimension", TextFormatting.GREEN.toString(), TelepadTarget.getDimenionName(dim))));
      }
