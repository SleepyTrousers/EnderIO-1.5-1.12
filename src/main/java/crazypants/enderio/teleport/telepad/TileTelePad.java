...
public class TileTelePad extends TileTravelAnchor implements IInternalPowerReceiver, ITelePad, IProgressTile {
    ...
    private boolean serverTeleport(Entity entity) {
        ...
        if (from != targetDim) {
            ...
            server.worldServerForDimension(entity.dimension)
                    .playSoundEffect(entity.posX, entity.posY, entity.posZ, TravelSource.TELEPAD.sound, 1.0F, 1.0F);
    ...
    public int getMaxEnergyRecieved(ForgeDirection dir) {
        return inNetwork() && master != null
                ? master == this ? energy.getMaxReceive() : master.getMaxEnergyRecieved(dir)
                : 0;
    }
    ...
    public int getMaxEnergyStored() {
        return inNetwork() && master != null
                ? master == this ? energy.getMaxEnergyStored() : master.getMaxEnergyStored()
                : 0;
    }
