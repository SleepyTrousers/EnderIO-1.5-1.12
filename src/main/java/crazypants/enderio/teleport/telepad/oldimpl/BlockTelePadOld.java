...
public class BlockTelePadOld extends BlockTravelAnchor<TileTelePadOld> implements IPaintable.ISolidBlockPaintableBlock {

  @SideOnly(Side.CLIENT)
  private static IRenderMapper RENDER_MAPPER;

  public static BlockTelePadOld createTelepad() {
    ...
    BlockTelePadOld ret = new BlockTelePadOld();
    ret.init();
    return ret;
  }

  protected BlockTelePadOld() {
    super(ModObject.blockTelePad.getUnlocalisedName(), TileTelePadOld.class);
  ...
  protected void setBlockStateWrapperCache(@Nonnull IBlockStateWrapper blockStateWrapper, @Nonnull IBlockAccess world, @Nonnull BlockPos pos,
      @Nonnull TileTelePadOld tileEntity) {
  ...
  public AxisAlignedBB getSelectedBoundingBox(IBlockState bs, World world, BlockPos pos) {
    if (world != null && pos != null) {
      TileTelePadOld tileEntity = getTileEntity(world, pos);
  ...
  public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
    ...
    if(te instanceof TileTelePadOld) {
      ...
      case GuiHandler.GUI_ID_TELEPAD_TRAVEL:
        return new ContainerTravelAccessable(player.inventory, (TileTelePadOld) te, world);
      default:
  ...
  public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
    ...
    if(te instanceof TileTelePadOld) {
      switch (ID) {
      case GuiHandler.GUI_ID_TELEPAD:
        return new GuiTelePad(player.inventory, (TileTelePadOld) te, world);
      case GuiHandler.GUI_ID_TELEPAD_TRAVEL:
        return new GuiAugmentedTravelAccessible(player.inventory, (TileTelePadOld) te, world);
      default:
