...
public final class Config {
  ...
  public static void processConfig(@SuppressWarnings("hiding") Configuration config) {
    ...
    darkSteelSolarOneCost = config.get(sectionDarkSteel.name, "darkSteelSolarOneCost", darkSteelSolarOneCost, "Cost in XP levels of the Solar I upgrade.")
        .getInt();
    ...
    darkSteelSolarTwoCost = config.get(sectionDarkSteel.name, "darkSteelSolarTwoCost", darkSteelSolarTwoCost, "Cost in XP levels of the Solar II upgrade.")
        .getInt();
    ...
    darkSteelSolarThreeCost = config
        .get(sectionDarkSteel.name, "darkSteelSolarThreeCost", darkSteelSolarThreeCost, "Cost in XP levels of the Solar III upgrade.").getInt();
