...
public class WailaCompat implements IWailaDataProvider {
    ...
    private class WailaWorldWrapper extends World {
        ...
        private WailaWorldWrapper(World wrapped) {
            super(
                    wrapped.getSaveHandler(),
                    wrapped.getWorldInfo().getWorldName(),
                    wrapped.provider,
                    new WorldSettings(wrapped.getWorldInfo()),
                    wrapped.theProfiler);
    ...
    public static void load(IWailaRegistrar registrar) {
        ...
        ConfigHandler.instance()
                .addConfig(EnderIO.MOD_NAME, "facades.hidden", EnderIO.lang.localize("waila.config.hiddenfacades"));
    }
