...
/**
 * This class provides the keys for the IMC messages supported by EIO and links the the details of how the messages are
 * processed. It is preferable not to refer to these constants directly to avoid a dependence on this class.
 */
public final class IMC {

    /**
     * Key for a string message to add Vat recipes. Calls {@link VatRecipeManager#addCustomRecipes(String)} with the
     * string value of the message.
     */
    public static final String VAT_RECIPE = "recipe:vat";

    /**
     * Key for a string message to add SAGMill recipes. Calls {@link CrusherRecipeManager#addCustomRecipes(String)} with
     * the string value of the message.
     */
    public static final String SAG_RECIPE = "recipe:sagmill";

    /**
     * Key for a string message to add Alloy Smelter recipes. Calls {@link AlloyRecipeManager#addCustomRecipes(String)}
     * with the string value of the message.
     */
    public static final String ALLOY_RECIPE = "recipe:alloysmelter";

    /**
     * Key for a string message to add Enchanter recipes. Calls {@link EnchanterRecipeManager#addCustomRecipes(String)}
     * with the string value of the message. The supplied xml is treated as if it was loaded from
     ...
     * {@link SliceAndSpliceRecipeManager#addCustomRecipes(String)} with the string value of the message.
     */
     ...
     * {@link SoulBinderRecipeManager#addRecipeFromNBT(net.minecraft.nbt.NBTTagCompound)} with the NBT value of the
     * message.
     */
    ...
    /**
     * Key for a string message to add an entity to the Powered Spawner blacklist. Calls
     * {@link PoweredSpawnerConfig#addToBlacklist(String)} with the string value of the message.
     */
     ...
     * {@link PoweredSpawnerConfig#addEntityCostFromNBT(net.minecraft.nbt.NBTTagCompound)} with the NBT value of the
     * message.
     */
     ...
     * {@link ItemSoulVessel#addEntityToBlackList(String)} with the string value of the message.
     */
     ...
     * {@link FluidFuelRegister#addFuel(net.minecraft.nbt.NBTTagCompound)} with the NBT value of the message.
     */
    public static final String FLUID_FUEL_ADD = "fluidFuel:add";

    /**
     * Key for an NBT message to register a fluid coolant. Calls
     * {@link FluidFuelRegister#addCoolant(net.minecraft.nbt.NBTTagCompound)} with the NBT value of the message.
     */
    public static final String FLUID_COOLANT_ADD = "fluidCoolant:add";

    /**
     * Key for a string message to add a block to the list of blocks that cannot be teleported through using the Staff
     * of Travel or Dark Steel Travel Upgrade. Value must be in the form: 'modid:blockName' Calls
     * {@link TravelController#addBlockToBlinkBlackList(String)} with the string value of the message.
     */
     ...
     * {@link InsulatedRedstoneConduit#addConnectableBlock(net.minecraft.nbt.NBTTagCompound)} with the NBT value of the
     * message.
     */
