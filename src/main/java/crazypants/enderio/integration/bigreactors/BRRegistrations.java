...
public class BRRegistrations {
  ...
  public static void init(FMLPreInitializationEvent event) {
    ...
    BRProxy.registerBlock(Alloy.ENERGETIC_ALLOY.getOreBlock(), 0.66f, 0.75f, 1.40f, conductivityGold);
    BRProxy.registerBlock(Alloy.VIBRANT_ALLOY.getOreBlock(), 0.80f, 0.70f, 1.38f, conductivityEmerald);
    ...
    BRProxy.registerFluid(Fluids.VAPOR_OF_LEVITY_NAME, 1f, 0.95f, 1.1f, conductivityGraphene);
    ...
    BRProxy.registerFluid(Fluids.LIQUID_SUNSHINE_NAME, 1f, 0.1f, 1.11f, conductivityWater);
    BRProxy.registerFluid(Fluids.CLOUD_SEED_NAME, 1f, 0.05f, 1.33f, conductivityWater);
    BRProxy.registerFluid(Fluids.CLOUD_SEED_CONCENTRATED_NAME, 1f, 0.005f, 2f, conductivityWater);

    BRProxy.registerFluid("redstone", 0.75f, 0.55f, 1.60f, conductivityEmerald);
    BRProxy.registerFluid("glowstone", 0.20f, 0.60f, 1.75f, conductivityCopper);
    BRProxy.registerFluid("ender", 0.90f, 0.75f, 2.00f, conductivityGold);
