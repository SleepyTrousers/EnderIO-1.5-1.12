...
public final class Config {
    ...
    public static String[] magnetBlacklist =
            new String[] {"appliedenergistics2:item.ItemCrystalSeed", "Botania:livingrock", "Botania:manaTablet"};
    ...
    public static int[] powerConduitEndergyTiers = {
        20, 40, 80, 160, 320, 1280, 2560, 10240, 40960, 81920, 327680, 2000000000
    };
    ...
    public static void load(FMLPreInitializationEvent event) {
        PacketHandler.INSTANCE.registerMessage(
                PacketConfigSync.class, PacketConfigSync.class, PacketHandler.nextID(), Side.CLIENT);
    ...
    public static void processConfig(Configuration config) {
        ...
        capacitorBankTierOneMaxStorageRF = config.get(
                        sectionPower.name,
        ...
        capacitorBankTierTwoMaxStorageRF = config.get(
                        sectionPower.name,
        ...
        capacitorBankTierThreeMaxIoRF = config.get(
                        sectionPower.name,
        ...
        capacitorBankTierThreeMaxStorageRF = config.get(
                        sectionPower.name,
        ...
        allowTileEntitiesAsPaintSource = config.get(
                        sectionRecipe.name,
        ...
        enchanterBaseLevelCost = config.get(
                ...
                .getInt(enchanterBaseLevelCost);

        photovoltaicCellEnabled = config.get(
                        sectionItems.name,
        ...
        maxPhotovoltaicAdvancedOutputRF = config.get(
                        sectionPower.name,
        ...
        useAlternateBinderRecipe = config.get(
                        sectionRecipe.name,
        ...
        fluidConduitExtractRate = config.get(
                        sectionEfficiency.name,
        ...
        fluidConduitMaxIoRate = config.get(
                        sectionEfficiency.name,
        ...
        advancedFluidConduitExtractRate = config.get(
                        sectionEfficiency.name,
        ...
        enderFluidConduitExtractRate = config.get(
                        sectionEfficiency.name,
        ...
        crystallineEnderFluidConduitExtractRate = config.get(
                        sectionEfficiency.name,
        ...
        melodicEnderFluidConduitExtractRate = config.get(
                        sectionEfficiency.name,
        ...
        stellarEnderFluidConduitExtractRate = config.get(
                        sectionEfficiency.name,
        ...
        gasConduitExtractRate = config.get(
                        sectionEfficiency.name,
        ...
        gasConduitMaxIoRate = config.get(
                        sectionEfficiency.name,
                        "gasConduitMaxIoRate",
                        gasConduitMaxIoRate,
        ...
        transceiverUpkeepCostRF = config.get(
                        sectionPower.name,
        ...
        transceiverBucketTransmissionCostRF = config.get(
                        sectionEfficiency.name,
        ...
        machineSoundVolume = (float)
                config.get(sectionPersonal.name, "machineSoundVolume", machineSoundVolume, "Volume of machine sounds.")
        ...
        vacuumChestRange = config.get(
                        sectionEfficiency.name, "vacumChestRange", vacuumChestRange, "The range of the vacuum chest")
                .getInt(vacuumChestRange);

        reinforcedObsidianEnabled = config.get(
                        sectionItems.name,
        ...
        travelAnchorEnabled = config.get(
                ...
                .getBoolean(travelAnchorEnabled);

        travelAnchorMaxDistance = config.get(
                        sectionAnchor.name,
        ...
        travelAnchorSkipWarning = config.get(
                        sectionAnchor.name,
        ...
        travelStaffMaxDistance = config.get(
                        sectionStaff.name,
        ...
        travelStaffPowerPerBlockRF = (float) config.get(
                        sectionStaff.name,
        ...
        travelStaffMaxBlinkDistance = config.get(
                        sectionStaff.name,
        ...
        travelStaffEnabled = config.get(
                ...
                .getBoolean(travelStaffEnabled);
        travelStaffBlinkEnabled = config.get(
                        sectionStaff.name,
        ...
        travelStaffBlinkThroughSolidBlocksEnabled = config.get(
                        sectionStaff.name,
        ...
        enderIoMeAccessEnabled = config.get(
                        sectionPersonal.name,
        ...
        darkSteelPowerStorageLevelOne = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelPowerStorageLevelTwo = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelPowerStorageLevelThree = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelPowerStorageLevelFour = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelUpgradePowerFourCost = config.get(
                ...
                .getInt(darkSteelUpgradePowerFourCost);
        ...
        darkSteelSpeedOneWalkModifier = (float) config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelSpeedTwoWalkMultiplier = (float) config.get(
                        sectionDarkSteel.name,
                        "darkSteelSpeedTwoWalkMultiplier",
                        darkSteelSpeedTwoWalkMultiplier,
                        "Speed modifier applied when walking in the Dark Steel Boots with Speed I.")
                .getDouble(darkSteelSpeedTwoWalkMultiplier);
        darkSteelSpeedThreeWalkMultiplier = (float) config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelSpeedOneSprintModifier = (float) config.get(
                        sectionDarkSteel.name,
                        "darkSteelSpeedOneSprintModifier",
                        darkSteelSpeedOneSprintModifier,
                        "Speed modifier applied when walking in the Dark Steel Boots with Speed I.")
                .getDouble(darkSteelSpeedOneSprintModifier);
        darkSteelSpeedTwoSprintMultiplier = (float) config.get(
                        sectionDarkSteel.name,
                        "darkSteelSpeedTwoSprintMultiplier",
                        darkSteelSpeedTwoSprintMultiplier,
                        "Speed modifier applied when walking in the Dark Steel Boots with Speed I.")
                .getDouble(darkSteelSpeedTwoSprintMultiplier);
        darkSteelSpeedThreeSprintMultiplier = (float) config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelBootsJumpModifier = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelPowerStorageBase = config.get(
                ...
                .getInt(darkSteelPowerStorageBase);
        darkSteelWalkPowerCost = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelSprintPowerCost = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelFallDistanceCost = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelGliderVerticalSpeedSprinting = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelSoundLocatorLifespan = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelGogglesOfRevealingCost = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelSolarOneCost = config.get(
                ...
                .getInt();
        darkSteelSolarOneGen = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelSolarTwoCost = config.get(
                ...
                .getInt();
        darkSteelSolarTwoGen = config.get(
                        sectionDarkSteel.name,
        ...
        ticCleaverSkullDropChance = (float) config.get(
                        sectionDarkSteel.name,
        ...
        ticBeheadingSkullModifier = (float) config.get(
                        sectionPersonal.name,
        ...
        darkSteelPickPowerUsePerDamagePoint = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelPickEffeciencyBoostWhenPowered = (float) config.get(
                ...
                .getDouble(darkSteelPickEffeciencyBoostWhenPowered);
        ...
        darkSteelAxePowerUsePerDamagePoint = config.get(
                        sectionDarkSteel.name,
                        "darkSteelAxePowerUsePerDamagePoint",
                        darkSteelAxePowerUsePerDamagePoint,
                        "Power use (RF) per damage/durability point avoided.")
                .getInt(darkSteelAxePowerUsePerDamagePoint);
        darkSteelAxePowerUsePerDamagePointMultiHarvest = config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelAxeEffeciencyBoostWhenPowered = (float) config.get(
                        ...
                        darkSteelAxeEffeciencyBoostWhenPowered,
                        "The increase in efficiency when powered.")
                .getDouble(darkSteelAxeEffeciencyBoostWhenPowered);
        ...
        darkSteelShearsEntityAreaBoostWhenPowered = (float) config.get(
                        sectionDarkSteel.name,
        ...
        darkSteelLadderSpeedBoost = (float) config.get(
                        sectionDarkSteel.name,
        ...
        hootchPowerPerCycleRF = config.get(
                        sectionPower.name,
        ...
        hootchPowerTotalBurnTime = config.get(
                        sectionPower.name,
        ...
        rocketFuelPowerPerCycleRF = config.get(
                        sectionPower.name,
        ...
        rocketFuelPowerTotalBurnTime = config.get(
                        sectionPower.name,
        ...
        fireWaterPowerPerCycleRF = config.get(
                        sectionPower.name,
                        "fireWaterPowerPerCycleRF",
                        fireWaterPowerPerCycleRF,
                        "The amount of power generated per BC engine cycle. Examples: BC Oil = 30, BC Fuel = 60")
                .getInt(fireWaterPowerPerCycleRF);
        fireWaterPowerTotalBurnTime = config.get(
                        sectionPower.name,
        ...
        frankenzombieGeneratorRfPerTick = config.get(
                        ...
                        frankenzombieGeneratorRfPerTick,
                        "The amount of power generated per tick.")
                .getInt(frankenzombieGeneratorRfPerTick);
        frankenzombieGeneratorTicksPerBucketFuel = config.get(
                        sectionPower.name,
        ...
        stirlingGeneratorBaseRfPerTick = config.get(
                        ...
                        stirlingGeneratorBaseRfPerTick,
                        "The amount of power generated per tick.")
                .getInt(stirlingGeneratorBaseRfPerTick);
        ...
        farmContinuousEnergyUseRF = config.get(
                ...
                .getInt(farmContinuousEnergyUseRF);
        farmActionEnergyUseRF = config.get(
                        sectionFarm.name,
        ...
        farmDefaultSize = config.get(
                ...
                .getInt(farmDefaultSize);
        farmBonusSize = config.get(
                        sectionFarm.name,
                        "farmBonusSize",
                        farmBonusSize,
        ...
        farmEssenceBerriesEnabled = config.get(
                        sectionFarm.name,
        ...
        farmManaBeansEnabled = config.get(
                        sectionFarm.name,
        ...
        combustionGeneratorUseOpaqueModel = config.get(
                        sectionAesthetic.name,
        ...
        magnetPowerUsePerSecondRF = config.get(
                        sectionMagnet.name,
        ...
        magnetAllowInMainInventory = config.get(
                        sectionMagnet.name,
        ...
        useCombustionGenModel = config.get(
                        sectionAesthetic.name,
        ...
        poweredSpawnerDespawnTimeSeconds = config.get(
                        sectionSpawner.name,
        ...
        poweredSpawnerSpawnRange = config.get(
                        sectionSpawner.name,
                        "poweredSpawnerSpawnRange",
                        poweredSpawnerSpawnRange,
        ...
        nutrientFoodBoostDelay = config.get(
                        sectionFluid.name,
        ...
        killerJoeNutrientUsePerAttackMb = config.get(
                        sectionKiller.name,
        ...
        soulBinderLevelOnePowerPerTickRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderLevelFourPowerPerTickRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderLevelFivePowerPerTickRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderLevelSixPowerPerTickRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderLevelSevenPowerPerTickRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderLevelEightPowerPerTickRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderLevelNinePowerPerTickRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderLevelTenPowerPerTickRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderBrokenSpawnerRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderAttractorCystalRF = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderEnderRailRF = config.get(
                ...
                .getInt(soulBinderEnderRailRF);

        soulBinderAttractorCystalLevels = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderBrokenSpawnerLevels = config.get(
                        sectionSoulBinder.name,
        ...
        soulBinderEnderRailLevels = config.get(
                ...
                .getInt(soulBinderEnderRailLevels);
        ...
        sliceAndSpliceLevelOnePowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelTwoPowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelThreePowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelFourPowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelFivePowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelSixPowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelSevenPowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelEightPowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelNinePowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        sliceAndSpliceLevelTenPowerPerTickRF = config.get(
                        sectionPower.name,
        ...
        lootDarkSteel = config.getBoolean(
                "lootDarkSteel", sectionLootConfig.name, lootDarkSteel, "Adds Darksteel Ingots to loot tables");
        ...
        lootNetherWart = config.getBoolean(
                "lootNetherWart", sectionLootConfig.name, lootNetherWart, "Adds nether wart to loot tables");
        lootEnderPearl = config.getBoolean(
                "lootEnderPearl", sectionLootConfig.name, lootEnderPearl, "Adds ender pearls to loot tables");
        ...
        lootPhasedIron = config.getBoolean(
                "lootPhasedIron", sectionLootConfig.name, lootPhasedIron, "Adds Phased Iron Ingots to loot tables");
        lootPhasedGold = config.getBoolean(
                "lootPhasedGold", sectionLootConfig.name, lootPhasedGold, "Adds Phased Gold Ingots to loot tables");
        lootTravelStaff = config.getBoolean(
                "lootTravelStaff", sectionLootConfig.name, lootTravelStaff, "Adds Travel Staff to loot tables");
        lootTheEnder = config.getBoolean(
                "lootTheEnder", sectionLootConfig.name, lootTheEnder, "Adds The Ender to loot tables");
        ...
        enderRailEnabled = config.getBoolean(
                "enderRailEnabled", sectionRailConfig.name, enderRailEnabled, "Whether Ender Rails are enabled");
        enderRailPowerRequireCrossDimensions = config.get(
        ...
        enderRailPowerRequiredPerBlock = config.get(
                        sectionRailConfig.name,
        ...
        enchantmentSoulBoundId = config.get(
                        sectionEnchantments.name,
        ...
        enchantmentSoulBoundWeight = config.get(
                        sectionEnchantments.name,
