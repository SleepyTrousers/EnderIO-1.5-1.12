...
public class FilterTab implements ITabPanel {
    ...
    FilterTab(GuiTransceiver parent) {
        ...
        sendGui = new BasicItemFilterGui(
                parent,
                new FilterContainer(parent.getTransciever(), true),
                false,
                true,
                container.getFilterOffset().x,
                container.getFilterOffset().y,
                0);
        recGui = new BasicItemFilterGui(
                parent,
                new FilterContainer(parent.getTransciever(), false),
                false,
                false,
                container.getFilterOffset().x,
                container.getFilterOffset().y,
