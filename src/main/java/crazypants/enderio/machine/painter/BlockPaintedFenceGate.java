...
public class BlockPaintedFenceGate extends BlockFenceGate implements ITileEntityProvider, IPaintedBlock {
    ...
    private void init() {
        GameRegistry.registerBlock(
                this, BlockItemPaintedFenceGate.class, ModObject.blockPaintedFenceGate.unlocalisedName);
        GameRegistry.registerTileEntity(
                TileEntityPaintedBlock.class, ModObject.blockPaintedFenceGate.unlocalisedName + "TileEntity");
        ...
        if (te instanceof TileEntityPaintedBlock) {
            ...
            if (tef.getSourceBlock() != null) {
                return Math.min(
                        ...
                        tef.getSourceBlock().getLightOpacity(world, x, y, z));
            }
        }
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int blockSide) {
        ...
        if (te instanceof TileEntityPaintedBlock) {
            TileEntityPaintedBlock tef = (TileEntityPaintedBlock) te;
            return tef.getSourceBlock() == null
                    ? null
                    : tef.getSourceBlock().getIcon(blockSide, tef.getSourceBlockMetadata());
