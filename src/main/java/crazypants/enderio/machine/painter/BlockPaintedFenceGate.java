...
public class BlockPaintedFenceGate extends BlockFenceGate implements ITileEntityProvider, IPaintedBlock {
    ...
    private void init() {
        GameRegistry
                .registerBlock(this, BlockItemPaintedFenceGate.class, ModObject.blockPaintedFenceGate.unlocalisedName);
        GameRegistry.registerTileEntity(
                TileEntityPaintedBlock.class,
                ModObject.blockPaintedFenceGate.unlocalisedName + "TileEntity");
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int blockSide) {
        ...
        if (te instanceof TileEntityPaintedBlock) {
            TileEntityPaintedBlock tef = (TileEntityPaintedBlock) te;
            return tef.getSourceBlock() == null ? null
