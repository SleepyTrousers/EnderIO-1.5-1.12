...
public class WirelessChargerRenderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(
        ...
        VertexTransform rot =
                new VertexRotation(Math.toRadians(45), new Vector3d(0, 1, 0), new Vector3d(0.5, 0.5, 0.5));
        ...
        CubeRenderer.render(
                BoundingBox.UNIT_CUBE.scale(0.2, 0.91, 0.2), EnderIO.blockWirelessCharger.getCenterOn(), true);
