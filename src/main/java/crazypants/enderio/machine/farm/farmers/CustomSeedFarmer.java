...
public class CustomSeedFarmer implements IFarmerJoe {
  ...
  protected boolean tillBlock(TileFarmStation farm, BlockPos plantingLocation) {
    ...
    if ((dirtBlock == Blocks.DIRT || dirtBlock == Blocks.GRASS) && farm.hasHoe()) {
      ...
      final SoundType soundType = Blocks.FARMLAND.getSoundType(Blocks.FARMLAND.getDefaultState(), world, dirtLoc, null);
      world.playSound(dirtLoc.getX() + 0.5F, dirtLoc.getY() + 0.5F, dirtLoc.getZ() + 0.5F, soundType.getStepSound(), SoundCategory.BLOCKS,
