...
public class SoulBinderReanimationRecipe implements IMachineRecipe, ISoulBinderRecipe {
  ...
  boolean isZombie(String mobType) {    
    ...
    return mobType != null && mobType.equals(EntityList.classToStringMapping.get(EntityZombie.class));
  }
  ...
  public List<String> getSupportedSouls() {    
    return Collections.singletonList((String)EntityList.classToStringMapping.get(EntityZombie.class));
  }
