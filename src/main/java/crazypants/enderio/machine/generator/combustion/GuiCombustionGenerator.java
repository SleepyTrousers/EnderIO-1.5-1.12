    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (gen.getCoolantTank().getFluidAmount() > 0) {
            ...
            RenderUtil.renderGuiTank(
                    gen.getCoolantTank().getFluid(),
                    4000,
                    gen.getCoolantTank().getFluidAmount() - 1000,
                    x,
                    y,
                    zLevel,
                    15,
            ...
            RenderUtil.renderGuiTank(
                    gen.getCoolantTank().getFluid(),
                    1000,
                    Math.min(gen.getCoolantTank().getFluidAmount(), 1000),
                    x,
                    y + 14,
                    zLevel,
                    33,
        ...
        if (gen.getFuelTank().getFluidAmount() > 0) {
            ...
            RenderUtil.renderGuiTank(
                    gen.getFuelTank().getFluid(),
                    4000,
                    gen.getFuelTank().getFluidAmount() - 1000,
                    x,
                    y,
                    zLevel,
                    15,
            ...
            RenderUtil.renderGuiTank(
                    gen.getFuelTank().getFluid(),
                    1000,
                    Math.min(gen.getFuelTank().getFluidAmount(), 1000),
                    guiLeft + 81,
                    guiTop + 38,
                    zLevel,
                    14,
