...
public class ContainerSliceAndSplice extends AbstractMachineContainer<TileSliceAndSplice> {
    ...
    private static final Item[] slotItems1 = { Items.wooden_axe, Items.stone_axe, Items.iron_axe, Items.golden_axe,
            Items.diamond_axe, DarkSteelItems.itemDarkSteelAxe };
    private static final Item[] slotItems2 = { Items.shears, Items.shears, Items.shears, Items.shears,
            DarkSteelItems.itemDarkSteelShears };
    private static final Random rand = new Random();

    public static final Point[] INPUT_SLOTS = new Point[] { new Point(44, 40), new Point(62, 40), new Point(80, 40),
            new Point(44, 58), new Point(62, 58), new Point(80, 58), new Point(54, 16), new Point(72, 16) };
