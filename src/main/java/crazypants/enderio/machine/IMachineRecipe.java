...
/**
 * A MachineRecipe implementation must be stateless, always returning the same values given the same parameters. The 'in
...
public interface IMachineRecipe {
    ...
    /**
     * The amount total number of MJ required to craft the recipe based on the inputs. The amount returned should be for
     * a single 'cycle' of the recipe. For examples, if the inputs would allow the recipe to completed 10 times, this
     * method should only return the amount of energy used for a single cycle.
     *
     * @param inputs
     * @return
     */
    ...
    /**
     * Only returns true if output can be generated using these inputs. If partially complete inputs are provided (for
     * example only one of two required inputs are present) the method should return false.
     *
     * @param inputs
     * @return
     */
    ...
    /**
     * Returns the experience a user gains when this recipe has generated the specified output. If the output is the
     * result of several recipe cycles, the accumulated total of experience gained for all cycles should be returned.
     *
     * @param output
     * @return
     */
    ...
    /**
     * Should return true if the specified parameter is can be used in this recipe.
     *
     * @param input
     * @return
     */
