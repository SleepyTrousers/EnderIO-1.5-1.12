...
public class MachineRecipes {
    ...
    public static void addRecipes() {
        ...
        addShaped(
                ...
                fusedQuartz,
                'z',
                new ItemStack(EnderIO.itemFrankenSkull, 1, 0));
        ...
        addShaped(
                ...
                fusedQuartz,
                'z',
                new ItemStack(EnderIO.itemFrankenSkull, 1, 2));
        ...
        addShaped(
                ...
                fusedQuartz,
                'z',
                new ItemStack(EnderIO.itemFrankenSkull, 1, 3));
        ...
        // addShaped(wirelessCharger, "svs", "imi", "scs", 's', electricSteel, 'i', silicon, 'm', machineChassi, 'c',
        // capacitor3, 'v', vibCry);
