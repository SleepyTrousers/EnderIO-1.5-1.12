      ...
      if(!getBundle().getEntity().worldObj.isRemote) {
        ...
        if(numEmptyEvents < 2) {
          if(network.fluidTypeLocked) {
            ...
            numEmptyEvents = 0;
            ChatMessageComponent c = ChatMessageComponent.func_111066_d(Lang.localize("itemLiquidConduit.unlockedType"));
      ...
      if(fluid != null) {
        if(!getBundle().getEntity().worldObj.isRemote) {
          if(network != null
            ...
            ChatMessageComponent c = ChatMessageComponent.func_111066_d(Lang.localize("itemLiquidConduit.lockedType") + " "
