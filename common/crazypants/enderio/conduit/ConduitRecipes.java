...
public class ConduitRecipes {
  ...
  public static void addRecipes() {
    ...
    GameRegistry.addShapedRecipe(new ItemStack(itemPowerConduit.actualId, 4, 2), " b ", "bib", " b ", 'b', industialBinder, 'i', new ItemStack(
        ModObject.itemAlloy.actualId, 1, Alloy.ENDER_IRON.ordinal()));
