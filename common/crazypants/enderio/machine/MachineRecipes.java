...
import static crazypants.enderio.ModObject.itemBasicGear;
...
public class MachineRecipes {
  ...
  public static void addRecipes() {
    ...
    ItemStack machineChassi = new ItemStack(ModObject.blockMachineChassi.actualId, 1, 0);
    ItemStack stirlingGen = new ItemStack(blockStirlingGenerator.actualId, 1, 0);
    ItemStack basicGear = new ItemStack(itemBasicGear.actualId, 1, 0);
    ...
    ItemStack redstoneInductor = new ItemStack(ModObject.itemRedstoneInductor.actualId, 1, 0);
