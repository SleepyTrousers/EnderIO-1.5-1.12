...
public final class CapBankConfig {
  ...
  public static final @Nonnull IValue<Integer> tierC_maxIO = F.make("tierC_maxIO", 50000, //
      "The maximum IO per tick for a creative capacitor bank.").setRange(1, MAXIO).sync();

  public static final @Nonnull IValue<Integer> tierC_maxStorage = F.make("tierC_maxStorage", 100000000, //
      "The maximum storage for a creative capacitor bank.").setRange(1, MAX).sync();

  public static final @Nonnull IValue<Integer> tier1_maxIO = F.make("tier1_maxIO", 1000, //
      "The maximum IO per tick for a single tier one capacitor bank.").setRange(1, MAXIO).sync();

  public static final @Nonnull IValue<Integer> tier1_maxStorage = F.make("tier1_maxStorage", 1000000, //
      "The maximum storage for a single tier one capacitor bank.").setRange(1, MAX).sync();

  public static final @Nonnull IValue<Integer> tier2_maxIO = F.make("tier2_maxIO", 5000, //
      "The maximum IO per tick for a single tier two capacitor bank.").setRange(1, MAXIO).sync();

  public static final @Nonnull IValue<Integer> tier2_maxStorage = F.make("tier2_maxStorage", 5000000, //
      "The maximum storage for a single tier two capacitor bank.").setRange(1, MAX).sync();

  public static final @Nonnull IValue<Integer> tier3_maxIO = F.make("tier3_maxIO", 25000, //
      "The maximum IO per tick for a single tier three capacitor bank.").setRange(1, MAXIO).sync();

  public static final @Nonnull IValue<Integer> tier3_maxStorage = F.make("tier3_maxStorage", 25000000, //
