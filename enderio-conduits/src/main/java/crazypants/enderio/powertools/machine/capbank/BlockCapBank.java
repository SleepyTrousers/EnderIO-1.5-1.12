...
public class BlockCapBank extends BlockEio<TileCapBank> implements IGuiHandler, IAdvancedTooltipProvider, IRedstoneConnectable,
  ...
  protected BlockCapBank() {
    super(PowerToolObject.blockCapBank, TileCapBank.class);
    setHardness(2.0F);
  ...
  public void addBasicEntries(ItemStack itemstack, EntityPlayer entityplayer, List<String> list, boolean flag) {
    list.add(LangPower.RF(BlockItemCapBank.getStoredEnergyForItem(itemstack), CapBankType.getTypeFromMeta(itemstack.getItemDamage())
        .getMaxEnergyStored()));
    ...
    if (world != null && pos != null && state != null && entityPlayer != null && hand != null && faceHit != null) {
      ...
      if (!entityPlayer.isSneaking() && ToolUtil.isToolEquipped(entityPlayer, hand)) {
        ...
        if (world.isRemote) {
          ...
          final Block blockCapBank2 = PowerToolObject.blockCapBank.getBlock();
