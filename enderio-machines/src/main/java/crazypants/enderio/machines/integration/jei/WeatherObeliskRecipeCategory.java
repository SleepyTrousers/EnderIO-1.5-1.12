...
public class WeatherObeliskRecipeCategory extends BlankRecipeCategory<WeatherObeliskRecipeCategory.WeatherObeliskRecipeWrapper> {
  ...
  public static void register(IModRegistry registry, @Nonnull IGuiHelper guiHelper) {
    ...
    result.add(new WeatherObeliskRecipeWrapper(new ItemStack(Items.FIREWORKS),
        ...
        WeatherConfig.weatherObeliskClearFluid.get() / CapacitorKey.WEATHER_POWER_FLUID_USE.get(DefaultCapacitorData.BASIC_CAPACITOR)
            * CapacitorKey.WEATHER_POWER_USE.get(DefaultCapacitorData.BASIC_CAPACITOR),
        "weather_sun", guiHelper));

    result.add(new WeatherObeliskRecipeWrapper(new ItemStack(Items.FIREWORKS),
        new FluidStack(Fluids.CLOUD_SEED.getFluid(), WeatherConfig.weatherObeliskRainFluid.get()),
        WeatherConfig.weatherObeliskRainFluid.get() / CapacitorKey.WEATHER_POWER_FLUID_USE.get(DefaultCapacitorData.BASIC_CAPACITOR)
            * CapacitorKey.WEATHER_POWER_USE.get(DefaultCapacitorData.BASIC_CAPACITOR),
    ...
    result.add(new WeatherObeliskRecipeWrapper(new ItemStack(Items.FIREWORKS),
        ...
        WeatherConfig.weatherObeliskThunderFluid.get() / CapacitorKey.WEATHER_POWER_FLUID_USE.get(DefaultCapacitorData.BASIC_CAPACITOR)
            * CapacitorKey.WEATHER_POWER_USE.get(DefaultCapacitorData.BASIC_CAPACITOR),
