...
public class ContainerTank extends AbstractMachineContainer<TileTank> {
  ...
  public static final Things slotItemsEmpty = new Things().add(Items.BUCKET);
  public static final Things mendables = new Things("minecraft:iron_shovel", "minecraft:iron_pickaxe", "minecraft:iron_axe", "minecraft:iron_sword",
